!(function (e, t) {
      ...
      function () {
        ...
        for (
          "boolean" == typeof o && ((u = o), (o = arguments[s] || {}), s++),
            "object" == typeof o || w.isFunction(o) || (o = {}),
            s === a && ((o = this), s--);
          s < a;
          s++
        )
          if (null != (e = arguments[s]))
            for (t in e)
              (i = o[t]),
                (n = e[t]),
                o !== n &&
                  (u && n && (w.isPlainObject(n) || (r = w.isArray(n)))
                    ? ((i = r
                        ? ((r = !1), i && w.isArray(i) ? i : [])
                        : i && w.isPlainObject(i)
                        ? i
    ...
    w.extend({
      ...
      each: function (e, t, n) {
        var r,
          ...
          s = p(e);
        if (n) {
          if (s) for (; i < o && !1 !== (r = t.apply(e[i], n)); i++);
          else for (i in e) if (((r = t.apply(e[i], n)), !1 === r)) break;
        } else if (s) for (; i < o && !1 !== (r = t.call(e[i], i, e[i])); i++);
      ...
      map: function (e, t, n) {
        var r,
          ...
          o = e.length,
          s = [];
        if (p(e)) for (; i < o; i++) null != (r = t(e[i], i, n)) && s.push(r);
        else for (i in e) (r = t(e[i], i, n)), null != r && s.push(r);
        return g.apply([], s);
      },
      guid: 1,
      proxy: function (e, t) {
  ...
  var d = (function (n) {
    ...
    try {
      L.apply((j = q.call(C.childNodes)), C.childNodes),
        ...
        return u !== T && 9 === u.nodeType && u.documentElement
          ? ((r = (T = u).documentElement),
            ...
            (d.getById = ie(function (e) {
              return (
                (r.appendChild(e).id = x),
                !u.getElementsByName || !u.getElementsByName(x).length
              );
            })),
            d.getById
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!d.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === u || (e.ownerDocument === C && y(C, e))
                        ? -1
                        : t === u || (t.ownerDocument === C && y(C, t))
                        ? 1
                        : l
      ...
      return (
        ...
        re(function (e, t, n, r) {
          var i,
            ...
            p = g ? (v || (e ? d : l || m) ? [] : t) : f;
          if ((g && g(f, p, n, r), m))
            for (i = he(p, u), m(i, [], n, r), o = i.length; o--; )
              (s = i[o]) && (p[u[o]] = !(f[u[o]] = s));
          if (e) {
            if (v || d) {
              if (v) {
    ...
    return (
              ...
              ((o = (function e(t) {
                for (
                  ...
                  if ((n = b.relative[t[u].type])) f = [pe(de(f), n)];
                    ...
                    if (
                      (n = b.filter[t[u].type].apply(null, t[u].matches))[x]
                    ) {
      ...
      (d.sortStable = x.split("").sort(k).join("") === x),
  ...
  (w.find = d),
    ...
    (w.unique = d.uniqueSort),
    (w.text = d.getText),
    (w.isXMLDoc = d.isXML),
    (w.contains = d.contains);
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      find: function (e) {
        ...
        return (
          ((r = this.pushStack(1 < n ? w.unique(r) : r)).selector = this
            .selector
            ? this.selector + " " + e
            : e),
          r
      ...
      is: function (e) {
        return !!C(this, "string" == typeof e && x.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var N,
  ...
  ((w.fn.init = function (e, t) {
    ...
    if (n[1]) {
      if (
        ...
        w.merge(
          this,
          w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : y, !0)
        ),
        b.test(n[1]) && w.isPlainObject(t))
      )
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            i = this.length,
            o = [],
            s = x.test(e) || "string" != typeof e ? w(e, t || this.context) : 0;
          r < i;
          r++
        )
    ...
    w.each(
      ...
      function (r, i) {
        w.fn[r] = function (e, t) {
          ...
          return (
            "Until" !== r.slice(-5) && (t = e),
            t && "string" == typeof t && (n = w.filter(t, n)),
            1 < this.length && (D[r] || w.unique(n), E.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
      ...
      return (
        S ||
          ...
          "complete" === y.readyState
            ? setTimeout(w.ready)
            : (y.addEventListener("DOMContentLoaded", q, !1),
    ...
    (O.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (void 0 === t) this.cache[e] = {};
          ...
          n = (r = w.isArray(t)
            ? t.concat(t.map(w.camelCase))
            : ((e = w.camelCase(t)),
              t in i ? [t, e] : (r = e) in i ? [r] : r.match(A) || [])).length;
          for (; n--; ) delete i[r[n]];
        }
      },
      hasData: function (e) {
            ...
            : H(
                ...
                function (t) {
                  var e,
                    n = w.camelCase(r);
                  if (o && void 0 === t)
                    return void 0 !== (e = P.get(o, r)) ||
                      void 0 !== (e = P.get(o, n))
                      ? e
                      : void 0 !== (e = W(o, n, void 0))
                      ? e
                      : void 0;
                  this.each(function () {
                    var e = P.get(this, n);
        ...
        if (
          ...
          for (t = s.length; t--; )
            0 === (n = s[t].name).indexOf("data-") &&
              ((n = w.camelCase(n.slice(5))), W(o, n, i[n]));
  ...
  ((u = y
    ...
    (v.checkClone = u.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (u.innerHTML = "<textarea>x</textarea>"),
    (v.noCloneChecked = !!u.cloneNode(!0).lastChild.defaultValue);
  var _ = "undefined";
  ...
  (w.event = {
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (s = h.handle) ||
              (s = h.handle =
                function (e) {
                  return typeof w != _ && w.event.triggered !== e.type
                    ? w.event.dispatch.apply(t, arguments)
                    : void 0;
                }),
            u = (e = (e || "").match(A) || [""]).length;
          u--;
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        3 !== n.nodeType &&
        8 !== n.nodeType &&
        !U.test(f + w.event.triggered) &&
        (0 <= f.indexOf(".") && ((f = (p = f.split(".")).shift()), p.sort()),
        (a = f.indexOf(":") < 0 && "on" + f),
        ((e = e[w.expando]
          ? e
          : new w.Event(f, "object" == typeof e && e)).isTrigger = r ? 2 : 3),
        (e.namespace = p.join(".")),
        ...
        for (i = 0; (d = c[i++]) && !e.isPropagationStopped(); )
          (e.type = 1 < i ? s : l.bindType || f),
            (u = (F.get(d, "events") || {})[e.type] && F.get(d, "handle")) &&
              u.apply(d, t),
            (u = a && d[a]) &&
              u.apply &&
              w.acceptData(d) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          o = w.event.handlers.call(this, e, a), t = 0;
    ...
    v.focusinBubbles ||
      w.each({ focus: "focusin", blur: "focusout" }, function (n, r) {
        function i(e) {
        ...
        w.event.special[r] = {
          ...
          teardown: function () {
            ...
            t
              ? F.access(e, r, t)
              : (e.removeEventListener(n, i, !0), F.remove(e, r));
          },
        };
      }),
    w.fn.extend({
  ...
  function se(e, t) {
    return w.nodeName(e, "table") &&
      w.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr")
  ...
  function ce(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        F.hasData(e) &&
        ((o = F.access(e)), (s = F.set(t, o)), (a = o.events))
      )
  ...
  (oe.optgroup = oe.option),
    ...
    w.extend({
        ...
        if (
          ...
          for (s = fe(c), r = 0, i = (o = fe(e)).length; r < i; r++)
            (a = o[r]),
              (u = s[r]),
              (l = void 0),
              "input" === (l = u.nodeName.toLowerCase()) && I.test(a.type)
                ? (u.checked = a.checked)
                : ("input" !== l && "textarea" !== l) ||
      ...
      buildFragment: function (e, t, n, r) {
        ...
        for (l.textContent = "", f = 0; (i = c[f++]); )
          if (
            (!r || -1 === w.inArray(i, r)) &&
            ((a = w.contains(i.ownerDocument, i)),
      ...
      cleanData: function (e) {
        for (
          var t, n, r, i, o, s, a = w.event.special, u = 0;
          void 0 !== (n = e[u]);
          u++
        ) {
          if (w.acceptData(n) && (o = n[F.expando]) && (t = F.cache[o])) {
            if ((r = Object.keys(t.events || {})).length)
              for (s = 0; void 0 !== (i = r[s]); s++)
                a[i] ? w.event.remove(n, i) : w.removeEvent(n, i, t.handle);
    ...
    w.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || w.cleanData(fe(n)),
            n.parentNode &&
              (t && w.contains(n.ownerDocument, n) && le(fe(n, "script")),
      ...
      domManip: function (n, r) {
        ...
        if (
          l &&
          ((t = (e = w.buildFragment(n, this[0].ownerDocument, !1, this))
            .firstChild),
          1 === e.childNodes.length && (e = t),
          t)
        ) {
          for (o = (i = w.map(fe(e, "script"), ae)).length; u < l; u++)
            (s = e),
              u !== f &&
                ((s = w.clone(s, !0, !0)), o && w.merge(i, fe(s, "script"))),
              r.call(this[u], s, u);
          if (o)
            for (
              a = i[i.length - 1].ownerDocument, w.map(i, ue), u = 0;
              u < o;
              u++
            )
              (s = i[u]),
                ne.test(s.type || "") &&
                  ...
                  w.contains(a, s) &&
                  (s.src
                    ? w._evalUrl && w._evalUrl(s.src)
                    : w.globalEval(s.textContent.replace(ie, "")));
        }
        return this;
      },
    }),
    w.each(
      ...
      function (e, s) {
        w.fn[e] = function (e) {
          for (var t, n = [], r = w(e), i = r.length - 1, o = 0; o <= i; o++)
  ...
  var pe,
    de = {};
  function he(e, t) {
    (e = w(t.createElement(e)).appendTo(t.body)),
  ...
  function ge(e) {
    ...
    return (
      n ||
        (("none" !== (n = he(e, t)) && n) ||
          ((t = (pe = (
            pe || w("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function Ne(e, t, n) {
    ...
    return (
      ...
      n &&
        ("" !== i || w.contains(e.ownerDocument, e) || (i = w.style(e, t)),
        Te.test(i) &&
          we.test(t) &&
          ((r = o.width),
          (e = o.minWidth),
  ...
  function Fe(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += w.css(e, n + B[o], !0, i)),
        r
          ? ("content" === n && (s -= w.css(e, "padding" + B[o], !0, i)),
            "margin" !== n && (s -= w.css(e, "border" + B[o] + "Width", !0, i)))
          : ((s += w.css(e, "padding" + B[o], !0, i)),
            "padding" !== n &&
              (s += w.css(e, "border" + B[o] + "Width", !0, i)));
    return s;
  }
  function Pe(e, t, n) {
    var r = !0,
      ...
      (r = e[s]).style &&
        ...
        t
          ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              $(r) &&
              (o[s] = F.access(r, "olddisplay", ge(r.nodeName))))
          : o[s] ||
            ((i = $(r)),
            ((n && "none" !== n) || !i) &&
              F.set(r, "olddisplay", i ? n : w.css(r, "display"))));
    for (s = 0; s < a; s++)
      (r = e[s]).style &&
  ...
  w.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = e.style;
        return (
          (t = w.cssProps[a] || (w.cssProps[a] = He(u, a))),
          ...
          void 0 === n
            ...
            : ("string" === (o = typeof n) &&
                (i = Se.exec(n)) &&
                ((n = (i[1] + 1) * i[2] + parseFloat(w.css(e, t))),
                (o = "number")),
              void (
                null != n &&
                n == n &&
                ("number" !== o || w.cssNumber[a] || (n += "px"),
                v.clearCloneStyle ||
                  "" !== n ||
    ...
    css: function (e, t, n, r) {
      var i,
        o = w.camelCase(t);
      return (
        (t = w.cssProps[o] || (w.cssProps[o] = He(e.style, o))),
        (o = w.cssHooks[t] || w.cssHooks[o]) &&
          "get" in o &&
          (i = o.get(e, !0, n)),
        void 0 === i && (i = Ne(e, t, r)),
        "normal" === i && t in Le && (i = Le[t]),
        "" === n || n
          ? ((t = parseFloat(i)), !0 === n || w.isNumeric(t) ? t || 0 : i)
          : i
      );
    },
  }),
    w.each(["height", "width"], function (e, i) {
      w.cssHooks[i] = {
        get: function (e, t, n) {
          return t
            ? 0 === e.offsetWidth && De.test(w.css(e, "display"))
              ? w.swap(e, Ae, function () {
                  return Pe(e, i, n);
                })
              : Pe(e, i, n)
            : void 0;
        ...
        set: function (e, t, n) {
          ...
          return Oe(
            ...
            t,
            n
              ? Fe(e, i, n, "border-box" === w.css(e, "boxSizing", !1, r), r)
              : 0
          );
        },
      };
    ...
    (w.cssHooks.marginRight = ke(v.reliableMarginRight, function (e, t) {
      return t
        ? w.swap(e, { display: "inline-block" }, Ne, [e, "marginRight"])
        : void 0;
    })),
    w.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
      (w.cssHooks[i + o] = {
        expand: function (e) {
          for (
    ...
    Xe = [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          "none" === (l = w.css(t, "display")) && (l = ge(t.nodeName)),
          "inline" === l &&
            "none" === w.css(t, "float") &&
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            o =
              (w.cssNumber[e] || ("px" !== i && +r)) &&
              Ie.exec(w.css(n.elem, e)),
            s = 1,
            a = 20;
          if (o && o[3] !== i)
            for (
  ...
  function Ge(i, e, t) {
    var n,
      ...
      l = a.promise({
        elem: i,
        props: w.extend({}, e),
        opts: w.extend(!0, { specialEasing: {} }, t),
    ...
    return (
      w.map(c, Ye, l),
      w.isFunction(l.opts.start) && l.opts.start.call(i, l),
      w.fx.timer(w.extend(u, { elem: i, anim: l, queue: l.opts.queue })),
      l
  ...
  (w.Animation = w.extend(Ge, {
    tweener: function (e, t) {
      for (
        var n,
          r = 0,
          i = (e = w.isFunction(e) ? ((t = e), ["*"]) : e.split(" ")).length;
        r < i;
        r++
      )
    ...
    (n = u.appendChild(y.createElement("option"))),
    (d.type = "checkbox"),
    (v.checkOn = "" !== d.value),
    (v.optSelected = n.selected),
    (u.disabled = !0),
    (v.optDisabled = !n.disabled),
    ((d = y.createElement("input")).value = "t"),
    (d.type = "radio"),
    (v.radioValue = "t" === d.value);
  var Qe,
    ...
    w.extend({
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute == _
            ...
            : ((1 === o && w.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  w.attrHooks[t] || (w.expr.match.bool.test(t) ? Qe : void 0))),
              void 0 === n
      ...
      removeAttr: function (e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = w.propFix[n] || n),
              w.expr.match.bool.test(n) && (e[r] = !1),
              e.removeAttribute(n);
      },
      attrHooks: {
        type: {
        ...
        : this.each(
            w.isFunction(i)
              ...
              : function () {
                  if ("string" == o)
                    for (
                      var e, t = 0, n = w(this), r = i.match(A) || [];
                      (e = r[t++]);
  ...
  w.fn.extend({
      ...
      return arguments.length
        ? ((r = w.isFunction(t)),
          this.each(function (e) {
            1 === this.nodeType &&
              (null == (e = r ? t.call(this, e, w(this).val()) : t)
                ? (e = "")
                : "number" == typeof e
                ? (e += "")
                : w.isArray(e) &&
        ...
        : i
        ? (n = w.valHooks[i.type] || w.valHooks[i.nodeName.toLowerCase()]) &&
          "get" in n &&
        ...
        select: {
              ...
              if (
                !(
                  ...
                  (t.parentNode.disabled &&
                    w.nodeName(t.parentNode, "optgroup"))
                )
              ) {
          ...
          set: function (e, t) {
            for (
              ...
              ((r = i[s]).selected = 0 <= w.inArray(w(r).val(), o)) && (n = !0);
    ...
    w.each(["radio", "checkbox"], function () {
      (w.valHooks[this] = {
        set: function (e, t) {
          return w.isArray(t)
            ? (e.checked = 0 <= w.inArray(w(e).val(), t))
            : void 0;
        },
      }),
        v.checkOn ||
  ...
  (rt = ct.exec(it.toLowerCase()) || []),
    w.extend({
      ...
      ajax: function (e, t) {
        ...
        d.ifModified &&
          (w.lastModified[l] &&
            b.setRequestHeader("If-Modified-Since", w.lastModified[l]),
          w.etag[l] && b.setRequestHeader("If-None-Match", w.etag[l])),
            ...
            r
              ? (d.ifModified &&
                  ((n = b.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[l] = n),
                  (n = b.getResponseHeader("etag")) && (w.etag[l] = n)),
                204 === e || "HEAD" === d.type
                  ? (a = "nocontent")
                  : 304 === e
                  ? (a = "notmodified")
    ...
    w.each(["get", "post"], function (e, i) {
      w[i] = function (e, t, n, r) {
        return (
          w.isFunction(t) && ((r = r || n), (n = t), (t = void 0)),
          w.ajax({ url: e, type: i, dataType: r, data: t, success: n })
        );
      };
    }),
    w.each(
  ...
  (w.param = function (e, t) {
    ...
    var r,
      i = [];
    if (
      (void 0 === t && (t = w.ajaxSettings && w.ajaxSettings.traditional),
  ...
  (w.offset = {
      ...
      position: function () {
        if (this[0]) {
          var e,
            ...
            r = { top: 0, left: 0 };
          return (
            "fixed" === w.css(n, "position")
              ? (t = n.getBoundingClientRect())
              : ((e = this.offsetParent()),
                (t = this.offset()),
                w.nodeName(e[0], "html") || (r = e.offset()),
                (r.top += w.css(e[0], "borderTopWidth", !0)),
                (r.left += w.css(e[0], "borderLeftWidth", !0))),
            {
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !w.nodeName(e, "html") && "static" === w.css(e, "position");
    ...
    w.each(["top", "left"], function (e, n) {
      w.cssHooks[n] = ke(v.pixelPosition, function (e, t) {
        return t
          ? ((t = Ne(e, n)), Te.test(t) ? w(e).position()[n] + "px" : t)
          : void 0;
      });
    }),
    w.each({ Height: "height", Width: "width" }, function (o, s) {
      w.each(
